...
Как это работает:
	...
	1.	core-api содержит общие зависимости, интерфейсы и базовые библиотеки. Эти зависимости могут использовать другие модули через api.
	2.	core — это основная реализация, которая зависит от core-api и добавляет свои собственные библиотеки.
	3.	example — это пример использования фреймворка, где ты подключаешь как core, так и core-api для тестирования.
	4.	blank-template служит шаблоном для новых проектов, который включает минимальные зависимости и может быть использован для старта.
